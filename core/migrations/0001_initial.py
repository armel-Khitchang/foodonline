# Generated by Django 5.1.5 on 2025-01-22 06:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='This is the product', max_length=100)),
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=99999999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='2.99', max_digits=99999999999999)),
                ('specifications', models.TextField(blank=True, null=True)),
                ('product_status', models.CharField(choices=[('draft', 'Draft'), ('disabled', 'Disabled'), ('rejected', 'Rejected'), ('in_review', 'In review'), ('published', 'Published')], default='in_preview', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='I am a Amazing vendor', max_length=100)),
                ('address', models.CharField(default='123 Main street', max_length=100)),
                ('contact', models.CharField(default='+1 (XXX) XXX XXXX', max_length=100)),
